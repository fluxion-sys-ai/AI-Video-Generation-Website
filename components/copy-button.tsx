...
export function CopyButton({ text }: { text: string }) {
  ...
  return (
    <button
      ...
      className="hit absolute right-2 top-2 z-10 flex h-7 w-7 items-center justify-center rounded-[7px] border border-hairline bg-raised/80 text-muted backdrop-blur transition-colors hover:text-accent-ink"
    >
