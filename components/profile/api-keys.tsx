    ...
    <div className="max-w-3xl space-y-6">
      <div>
        ...
        <p className="mt-2 text-sm text-muted">
          Call the models from your own code with a bearer key. Keys draw on the same credit balance as
          the playground. See the <a href="/docs#quickstart" className="text-blue hover:text-gold-soft">quickstart</a> for
          the request shape.
        </p>
      </div>
