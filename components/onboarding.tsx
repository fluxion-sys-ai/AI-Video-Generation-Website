...
export function Onboarding() {
  ...
  // Complete sign-up. Backend mode already created the account on the first slide,
  // so this saves the chosen display name; the mock creates its local account here.
